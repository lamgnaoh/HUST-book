...
namespace AssignmentApp.Data.Migrations
{
    ...
    [Migration("20220930175735_table files")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssignmentApp.Data.Entities.File", b =>
                {
                    ...
                    b.Property<int>("StudentAssignmentAssignmentId")
                        .HasColumnType("int");

                    b.Property<int>("StudentAssignmentStudentId")
                        .HasColumnType("int");

                    b.HasKey("FileId");

                    b.HasIndex("StudentAssignmentAssignmentId", "StudentAssignmentStudentId");
            ...
            modelBuilder.Entity("AssignmentApp.Data.Entities.File", b =>
                {
                    b.HasOne("AssignmentApp.Data.Entities.StudentAssignment", "StudentAssignment")
                        .WithMany("SubmitFiles")
                        .HasForeignKey("StudentAssignmentAssignmentId", "StudentAssignmentStudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
